 ...
 */
export var PolygonDrawingTool = function (map, beforeLayer, drawingEndedCallback) {
  var _self = this;

  var _datasource = new window.atlas.source.DataSource();
  map.sources.add(_datasource);

  var _activeShape;

  var pl = new window.atlas.layer.PolygonLayer(_datasource, null, {
      fillColor: 'rgba(255,165,0,0.2)'
  });
  map.layers.add(pl, beforeLayer);

  map.layers.add(new window.atlas.layer.LineLayer(_datasource, null, {
      strokeColor: 'orange',
      strokeWidth: 2
  }), beforeLayer);
  ...
  var _dragHandleLayer = new window.atlas.layer.BubbleLayer(_datasource, null, {
      color: 'orange',
  ...
  ***********************/
  ...
  this.startDrawing = function () {
      ...
      _activeShape = new window.atlas.Shape(new window.atlas.data.Polygon([[[]]]));
